...
public class Notices extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        if(requestCode == GALLERY_INTENT && resultCode == RESULT_OK){
            ...
            if(data.getClipData()!=null){
                ...
                for(int i=0;i<totalItemsSelected;i++){
                    ...
                    StorageReference filetopath = multipleImageStorage.child("Notices").child(filePathValue).child(s);
                    filetopath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Notices.this, "done", Toast.LENGTH_SHORT).show();
                ...
                uploadProgress.show();
                final String filePathValue = FilePathName.getText().toString();
                StorageReference filepath = imageStorage.child("Notices").child(filePathValue).child("one");
                filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(Notices.this, "Upload Done", Toast.LENGTH_SHORT).show();
                        uploadProgress.dismiss();
                        Date todaysDate = new Date();
                        DateFormat df2 = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
                        String date = df2.format(todaysDate);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Notices.this, "Click on a specific notification to open it for the detailed information about the notification", Toast.LENGTH_LONG).show();
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(myedittext.getText().toString().trim().length()>0) {
                    ...
                    Toast.makeText(Notices.this, "Enter the notice before adding image", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        myApplyBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(Notices.this, "success", Toast.LENGTH_SHORT).show();
            }
        });
